...
@Data
@CsvRow("市级商品品类模板")
public class ProductSaleAnalyseOutDataCityCSV {
    ...
    @CsvCell(title = "商品分类描述", index = 34, fieldNo = 1)
