...
@Data
@CsvRow("门店商品品类模板")
public class ProductSaleAnalyseOutDataStoreCSV {
    ...
    @CsvCell(title = "门店ID", index = 5, fieldNo = 1)
    @ApiModelProperty(value = "门店编码")
    private String stoCode;
    @CsvCell(title = "门店名称", index = 6, fieldNo = 1)
    @ApiModelProperty(value = "门店名")
    private String stoName;
    @CsvCell(title = "店型", index = 7, fieldNo = 1)
    private String stoVersion;
    @CsvCell(title = "药德通用编码", index = 8, fieldNo = 1)
