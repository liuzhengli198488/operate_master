...
@Data
public class InventoryInquiryByClientAndSiteOutDataByBatch implements Serializable {
    ...
    @ExcelProperty(value = "有效期至", index = 11)
    private String validUntil;

    @ExcelProperty(value = "效期天数", index = 12)
    private Integer expiryData;

    @ApiModelProperty(value = "零售额")
    @ExcelProperty(value = "零售额", index = 13)
    private BigDecimal retailSales;

    @ApiModelProperty(value = "零售价")
    @ExcelProperty(value = "零售价", index = 14)
    private BigDecimal retailPrice;

    @ApiModelProperty(value = "会员价")
    @ExcelProperty(value = "会员价", index = 15)
    private BigDecimal memberPrice;

    @ApiModelProperty(value = "会员日价")
    @ExcelProperty(value = "会员日价", index = 16)
    private BigDecimal memberDayPrice;

    @ApiModelProperty(value = "入库日期")
    @ExcelProperty(value = "入库时间", index = 17)
    ...
    @ExcelProperty(value = "产地", index = 19)
    private String origin;

    @ApiModelProperty(value = "剂型")
    @ExcelProperty(value = "剂型", index = 20)
    ...
    @ExcelProperty(value = "批准文号", index = 23)
    private String approvalNum;

    @ApiModelProperty(value = "加点后含税成本价")
    @ExcelProperty(value = "成本价", index = 24)
    private BigDecimal addPrice;

    @ApiModelProperty(value = "加点后含税成本额")
    @ExcelProperty(value = "成本额", index = 25)
    private BigDecimal addAmount;

    @ApiModelProperty(value = "商品大类编码")
    @ExcelProperty(value = "商品大类编码", index = 26)
    private String bigClass;

    @ApiModelProperty(value = "商品中类编码")
    @ExcelProperty(value = "商品中类编码", index = 27)
    private String midClass;

    @ApiModelProperty(value = "商品分类编码")
    @ExcelProperty(value = "商品分类编码", index = 28)
    private String proClass;

    @ApiModelProperty(value = "是否医保")
    @ExcelProperty(value = "是否医保", index = 29)
    private String ifMed;

    @ApiModelProperty(value = "医保类型")
    @ExcelProperty(value = "医保类型", index = 30)
    private String yblx;

    @ApiModelProperty(value = "医保编码")
    @ExcelProperty(value = "医保编码", index = 31)
    private String medProdctCode;

    @ApiModelProperty(value = "医保刷卡数量")
    @ExcelProperty(value = "医保刷卡数量", index = 32)
    private String proMedQty;

    @ApiModelProperty(value = "是否批发")
    @ExcelProperty(value = "是否批发", index = 33)
    private String isWholeSale;

    //销售级别
    @ExcelProperty(value = "销售级别", index = 34)
    private String saleClass;

    @ApiModelProperty(value = "商品定位")
    @ExcelProperty(value = "商品定位", index = 35)
    private String proPosition;

    //商品自分类
    @ExcelProperty(value = "商品自分类", index = 36)
    ...
    @ExcelProperty(value = "自定义字段1", index = 38)
    private String zdy1;

    @ApiModelProperty(value = "自定义2")
    @ExcelProperty(value = "自定义字段2", index = 39)
    private String zdy2;

    @ApiModelProperty(value = "自定义3")
    @ExcelProperty(value = "自定义字段3", index = 40)
    private String zdy3;

    @ApiModelProperty(value = "自定义4")
    @ExcelProperty(value = "自定义字段4", index = 41)
    private String zdy4;

    @ApiModelProperty(value = "自定义5")
    @ExcelProperty(value = "自定义字段5", index = 42)
    private String zdy5;

    /**
     * 门店属性
     */
    @ExcelProperty(value = "门店属性", index = 43)
    private String stoAttribute;

    /**
     * 是否医保店
     */
    @ExcelProperty(value = "是否医保店", index = 44)
    private String stoIfMedical;

    /**
     * DTP
     */
    @ExcelProperty(value = "DTP", index = 45)
    private String stoIfDtp;

    /**
     * 纳税属性
     */
    @ExcelProperty(value = "纳税属性", index = 46)
    private String stoTaxClass;

    /**
     * 店型
     */
    @ExcelProperty(value = "铺货店型", index = 47)
    private String shopType;

    /**
     * 店效级别
     */
    @ExcelProperty(value = "店效级别", index = 48)
    private String storeEfficiencyLevel;

    /**
     * 是否直营管理
     */
    @ExcelProperty(value = "是否直营管理", index = 49)
    private String directManaged;

    /**
     * 管理区域
     */
    @ExcelProperty(value = "管理区域", index = 50)
    private String managementArea;

    @ExcelProperty(value = "最新进价", index = 51)
