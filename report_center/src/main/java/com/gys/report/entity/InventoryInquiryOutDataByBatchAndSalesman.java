...
@Data
public class InventoryInquiryOutDataByBatchAndSalesman implements Serializable {
    ...
    @ExcelProperty(value = "业务员编码", index = 43)
    private String saleCode;

    @ApiModelProperty(value = "业务员名字")
    @ExcelProperty(value = "业务员名字", index = 44)
    private String saleName;

    @ExcelProperty(value = "最新进价", index = 45)
